...
Route::middleware(['web','auth'])->group(function () {
	...
	Route::get('/dashboard', \Thephpx\User\Http\Controllers\User\Dashboard::class)->name('dashboard.index');
	...
	Route::prefix('user')->group(function () {
		...
		Route::get('/', \Thephpx\User\Http\Controllers\User\Index::class)->name('user.index');
		Route::get('/create', \Thephpx\User\Http\Controllers\User\Create::class)->name('user.create');
		Route::post('/create', \Thephpx\User\Http\Controllers\User\Create::class)->name('user.create.post');
		Route::get('/edit/{user}', \Thephpx\User\Http\Controllers\User\Edit::class)->name('user.edit');
		Route::put('/edit/{user}', \Thephpx\User\Http\Controllers\User\Edit::class)->name('user.edit.put');
		Route::delete('/remove/{user}', \Thephpx\User\Http\Controllers\User\Remove::class)->name('user.remove.delete');
