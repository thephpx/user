    ...
    <div class="container container-normal py-4">
        <div class="row align-items-center g-4">
                ...
                <div class="container-tight">
                    <div class="text-center mb-4">
                        <a href="." class="navbar-brand navbar-brand-autodark"><img
                                src="{{ asset('assets/tablerui/static/logo.svg') }}" height="36" alt=""></a>
                    </div>
                    <div class="card card-md">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="input-group input-group-flat">
                                        ...
                                        <span class="input-group-text">
                                            <a href="javascript:togglePassword('password')" class="link-secondary"
                        ...
                        @if(config('User.social-signin') == true)
            ...
            <div class="col-lg d-none d-lg-block">
                <img src="{{ asset('assets/tablerui/static/illustrations/undraw_secure_login_pdn4.svg') }}" height="300"
